...
### Справочник валют
- [ ] Добавлен endpoint `/api/v1/report-6406/dictionary/currencies`
- [ ] Реализована логика получения списка валют
- [ ] Обновлена OpenAPI спецификация

### Удаление устаревших endpoints
- [ ] Удалён endpoint `/api/v1/report-6406/references/report-types`
- [ ] Обновлена документация

### Обновление endpoints справочников
- [ ] Обновлён endpoint `/dictionary/branches` с новой структурой
- [ ] Обновлён endpoint `/dictionary/sources`
- [ ] Обновлена OpenAPI спецификация

### AccountMasks
- [ ] Реализован endpoint `/api/v1/report-6406/dictionary/account-masks`
- [ ] Response в формате связанного списка
- [ ] Обновлена OpenAPI спецификация

### Данные о пользователе
- [ ] Реализован endpoint `/api/v1/report-6406/dictionary/employee/{adLogin}`
- [ ] Реализована валидация adLogin
- [ ] Обновлена OpenAPI спецификация

### Переименование
- [ ] Все endpoints `/references` переименованы в `/dictionary`
- [ ] Обновлены все места использования
- [ ] Обновлена документация

### Имя endpoint списка заданий
- [ ] Проработано и согласовано новое имя
- [ ] Выполнено переименование (если требуется)
- [ ] Обновлена документация
...
- [ ] Обновлена OpenAPI спецификация
- [ ] Обновлена документация
- [ ] Обеспечена обратная совместимость или согласованы breaking changes
